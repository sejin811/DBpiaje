  ...
  import { getDatabase, ref, onValue, push, set, remove, child } from "https://www.gstatic.com/firebasejs/9.22.2/firebase-database.js";
  ...
  document.getElementById('imageInput').addEventListener('change', async (e) => {
    ...
    if (!file) return;
    try {
      const refPath = `images/${Date.now()}_${file.name}`;
